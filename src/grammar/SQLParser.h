...
// Generated from grammar/SQL.g4 by ANTLR 4.8
...
#define DELETE1 "DELETE FROM T0 WHERE ID = 2;"
#define DELETE2 "DELETE FROM T0 WHERE ID2 = 4;"
#define DELETE3 "UPDATE T01 SET T0_ID2 = 2, T0_ID = 2 WHERE T0_ID2 = 4;"
#define BREAK_INFO "!ERROR\nforeign"